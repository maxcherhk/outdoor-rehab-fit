	...
	en: {
		equipmentList: [
			...
			},
			{
				...
				kinesiologyTip:
					"This equipment assists the user in utilizing the strength of their upper body to lift themselves, thereby enhancing the strength of their upper body.",
				ptTip:
			...
			},
			{
				...
				kinesiologyTip:
					"By pushing the handlebars towards the center, this equipment can strengthen the muscles of the shoulders and arms of the user.",
				ptTip:
			...
			},
			{
				...
				kinesiologyTip:
					"Partial-lunge helps to strengthen the leg muscles, increase leg flexibility, and improve balance.",
				ptTip:
			...
			},
			{
				...
				kinesiologyTip:
					"This equipment helps to enhance the user's perception of balance and increase the strength of the lower limb muscles.",
				ptTip:
			...
			},
			{
				...
				kinesiologyTip:
					"By placing one foot on the stool, the user can stretch the muscles at the back of the thigh, improving the flexibility of the legs.",
				ptTip:
		...
		equipmentList: [
			{
				...
				kinesiologyTip:
					"使用這個健身設施時使用者要雙手轉動轉盤，這個動作能夠提升上肢關節的靈活性。 \n\n在轉動轉盤時使用者需維持下蹲的姿勢，此動作亦可以鍛煉到下肢的肌肉。",
				ptTip:
			...
			},
			{
				...
				ptTip:
					"引體上升能夠預防肩胛骨移位所致的膊頭痛。在背部和肩膊肌肉未有足夠的穩定性前，做引體上升時要小心控制升降的高度和速度，盡量不要令肩膊出現疼痛。",
				otTip:
			...
			},
			{
				...
				ptTip:
					"將手柄推向中間的動作能夠預防肩胛骨移位所致的膊頭痛。在上肢和核心肌肉未有足夠的穩定性前，推手柄的時侯要小心控制推和放的速度，盡量不要令肩膊出現疼痛。",
			...
			},
			{
				...
				kinesiologyTip:
					"這個健身設施能讓使用者活動到不同部份的身體部位。\n\n下肢伸展：腳踏斜坡動作可以伸展到臀部、後腿、小腿以及足底，提高這部分的柔韌程度。\n\n",
				ptTip:
					"腳踏斜坡可以幫助「足底筋膜炎」和「膝關節炎」的患者增加小腿肌肉的柔軟度，減輕腳底和膝關節的痛楚。企斜坡時，腳尖要指著正前方，不要「外八字腳」站立。",
			...
			},
			{
				...
				ptTip:
					"柔和的肩部伸展有助於「五十肩」和肩關節炎患者增加肩部肌肉的柔軟度並減輕肩膊的疼痛。伸展時，力度和幅度不能太大，應保持在一個不會加劇疼痛程度的範圍內。",
			...
			},
			{
				...
				kinesiologyTip:
					"透過站立在轉盤及左右扭動軀幹，使用者能夠有效地鍛煉軀幹、下肢力量。如果持續重覆此運動，更可以增強呼吸系統的功能。",
				ptTip:
			...
			},
			{
				...
				youtubeKey: "bKl8JHH4ZHg",
				kinesiologyTip:
					"這個健身設施能讓使用者的前腳掌高於後腳跟。\n\n維持這個姿勢能令使用者的小腿後方肌肉伸展，增加小腿柔韌度以及足踝靈活性，亦可以增加小腿的活動能力。",
				ptTip:
					"企斜板可以幫助「足底筋膜炎」和「膝關節炎」的患者增加小腿肌肉的柔軟度，減輕腳底和膝關節的痛楚。企斜板時，腳尖要指著正前方，不要「外八字腳」站立。",
			...
			},
			{
				...
				kinesiologyTip:
					"這個健身設施可以協助使用者透過上肢肌肉支撐身體重量，以完成站式掌上壓的動作。\n\n透過進行站式掌上壓訓練，可以增強使用者上肢肌肉的力量。",
				ptTip: "/",
				otTip:
			...
			},
			{
				...
				ptTip:
					"柔和的關節活動有助於「五十肩」和肩關節炎患者保持肩關節的活動幅度並減輕肩膊的疼痛。使用轉輪時，轉動的力度和幅度不能太大，應保持在一個不會加劇疼痛程度的範圍內。",
			...
			},
			{
				...
				horizontalPic: require("./../assets/images/horizontal/22.jpg"),
				details:
					"雙手緊握扶手，兩腳踩喺踏板上面。然後雙腳配合雙手上下擺動。\n\n運動嘅時候唔好完全伸直兩邊膝關節，亦要留意唔好過份屈曲膝關節。踩動嘅速度要平均，唔好時快時慢。",

				youtubeKey: "ktO92CXy1WA",
				kinesiologyTip:
					"這個健身設施可以協助使用者進行踏步的動作。從而鍛煉其下肢以及身體的平衡感知。持續鍛煉亦可以增強呼吸系統功能。",
				ptTip:
			...
			},
			{
				...
				kinesiologyTip:
					"下肢運動：交替踩腳踏的時候，提高腿部的動作可以增強腿部肌肉群的力量，同時亦能提升膝關節及足踝關節的活動能力。",
				ptTip:
			...
			},
			{
				...
				kinesiologyTip:
					"這個健身設施能協助使用者進行雙腳交替擺動的動作，使其可以活動膝關以及腳踝關節，並增強相關肌群的柔靭性。",
				ptTip:
