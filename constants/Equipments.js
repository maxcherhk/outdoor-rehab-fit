	...
	en: {
		equipmentList: [
			...
			},
			{
				...
				otTip: "Persistent training can strengthen the upper body, making activities like getting out of bed and pushing the wheelchair easier, thereby enhancing independence.",
				careTip:
			...
			},
			{
				...
				otTip: "Using the inclined ramp to stretch can enhance the flexibility of the lower limb muscles, making daily activities such as putting on pants or socks easier.",
				careTip:
			...
			},
			{
				...
				ptTip: "/",
				otTip: "The standing push-up can strengthen the upper limb muscles, helping with daily activities like carrying groceries or lifting heavy objects.",
				careTip:
		...
		equipmentList: [
			{
				...
				details:
					"首先，雙腳分開站立，站立嘅時候雙腳距離同膊頭一樣咁闊，臀部向下坐，雙腳微微屈曲，形成一個馬步。注意膝關節不能超過腳趾。\n\n兩隻手可以緊握住個手柄，然後以順時針或者逆時針推動個轉盤。\n\n推動轉盤嘅同時記得保持良好的姿勢。眼望前方，頭向上頂，延伸脊柱。唔好縮膊，膊頭遠離耳仔，膊頭轉向後，挺起胸膛。注意腰椎弧度不要過度，可以將尾骨指向前方，以調整腰椎弧度。\n\n我地宜家試下雙手順時針推動轉盤。記得力度要適中，轉速亦都要平均，唔好時快時慢。\n\n我地宜家試下右手順時針推動轉盤，左手逆時針推動轉盤。記得力度要適中，轉速亦都要平均，唔好時快時慢。\n\n最後，我地反方向再試下。記得力度要適中，轉速亦都要平均，唔好時快時慢。",
			...
			},
			{
				...
				details:
					"首先，我地調校好個阻力，而調校阻力嘅指標係直至你只需要稍為用力就可以轉動個手柄。調校好阻力之後，使用者可以手握手柄，然後開始轉動手柄。\n\n如果係初級嘅使用者，我地宜家可以試下向前手柄轉動60秒。\n\n記得力度要適中，轉速亦都要平均，唔好時快時慢。\n\n轉動手柄嘅時候記得保持良好的姿勢。眼望前方，頭向上頂，延伸脊柱。唔好縮膊，膊頭遠離耳仔，膊頭轉向後，挺起胸膛。\n\n我哋宜家可以停止轉動，休息10秒。\n\n我哋宜家可以試下向反方向轉動60秒。記得力度要適中，轉速亦都要平均，唔好時快時慢。做呢個運動嘅時候，如果喘氣程度令你唔能夠講野，就表示運動嘅強度太高。應該以能夠一邊講講，一邊轉動手柄，作為一個適合嘅運動量強度指標。\n\n我哋宜家可以停止轉動，休息10秒。\n\n我哋宜家可以試下向向前轉動60秒。記得力度要適中，轉速亦都要平均，唔好時快時慢。轉動嘅時候保持正常呼吸。\n\n如果係進階嘅使用者，可以加大阻力，並重複以上嘅運動。",
				...
				otTip: "持續使用這個健身設施可以改善使用者上半身關節的活動能力，亦可以增強其心肺功能，對過床、洗澡等日常生活的活動都有所幫助。",
				careTip:
			...
			},
			{
				...
				details:
					"首先將輪椅背向指示板泊好，將輪椅鎖好。然後雙手握住提升桿，將自己向上拉起。\n\n要留意上升嘅時候，身體應該要保持穩定，避免擺動身體借力，以免受傷。運動嗰陣保持正常呼吸。\n\n如果係初級嘅使用者，我地只需要將自己提升，直至自己身體帶俾輪椅嘅重量變輕，就可以啦。唔需要身體完全離開輪椅。\n\n宜家由1數到3，我地可以慢慢放低自己，坐翻喺輪椅上面。\n\n如果係進階嘅使用者，我地宜家可以試下將自己向上拉，直至離開輪椅，保持喺呢個位置，身體保持穩定。\n\n宜家由1數到5。我地可以放鬆背部肌肉，慢慢放低自己，坐翻喺輪椅上面。\n\n運動嘅時候，就算未必可以將自己拉起到完全離開輪椅，都仍然可以達到鍛煉嘅效果。",
				...
				otTip: "持續使用這部器材進行引體上升訓練，可以增強使用者的上身力量，使其過床以及推輪椅的時候更加容易，提升獨立能力。",
				careTip:
			...
			},
			{
				...
				details:
					"我地要先做伸展運動作準備，首先我地試下坐直個人，交叉雙臂環抱住自己，保持呢個姿勢10秒，慢慢放鬆。然後轉手，重複多一次交叉雙臂環抱自己嘅動作。\n\n運動開始嘅時候，可以先將輪椅面向指示板泊好，並且鎖好輪椅。\n\n首先握著手柄，然後將手柄推向中間，做呢個運動嘅時候，我地要眼望前方，頭向上頂，延伸脊柱。唔好縮膊，膊頭遠離耳仔，膊頭轉向後，挺起胸膛。\n\n宜家我地可以試下重複呢個動作10次。",
			...
			},
			{
				...
				details:
					"首先，我哋宜家試下雙手捉住橫杆，雙腳企喺斜台上面，行前一步或者行後一步，感受一下，調校一下係邊一個位置站立，感覺到小腿會有少許拉伸嘅感覺，然之後喺嗰個位置站立。由1數到30，保持正常呼吸。",

				kinesiologyTip: "這個健身設施能讓使用者活動到不同部份的身體部位。\n\n下肢伸展：腳踏斜坡動作可以伸展到臀部、後腿、小腿以及足底，提高這部分的柔韌程度。\n\n",
				ptTip: "腳踏斜坡可以幫助「足底筋膜炎」和「膝關節炎」的患者增加小腿肌肉的柔軟度，減輕腳底和膝關節的痛楚。企斜坡時，腳尖要指著正前方，不要「外八字腳」站立。",
				otTip: "練習腳踏斜坡可以令後腿柔韌度增強，使日常生活的活動，例如穿褲子或襪子的時候更加輕鬆。",
				careTip:
					"觀察及提醒使用者伸展時要動作要緩慢，逐步伸展，動作太大或太快會有受傷的風險。\n\n觀察及提醒使用者運動時有拉伸感覺即可，不應感到有強烈痛楚。\n\n觀察及提醒使用者保持正常呼吸。",
			},
			{
				id: 5,
				name: "全身伸展運動器 （肩關節伸展）",
				...
				ptTip: "柔和的肩部伸展有助於「五十肩」和肩關節炎患者增加肩部肌肉的柔軟度並減輕肩膊的疼痛。伸展時，力度和幅度不能太大，應保持在一個不會加劇疼痛程度的範圍內。",
			...
			},
			{
				...
				careTip: "在進行站式掌上壓時，觀察及提醒使用者保持背部同髖關節伸直。\n\n做這個動作時容易縮膊，觀察及提醒使用者將膊頭遠離耳仔。",
			},
			{
				id: 8,
				name: "扭腰機",
				...
				ptTip:
					"柔和地扭動軀幹有助於腰背痛的患者保持腰部的靈活性和柔軟度。腰背痛的患者使用扭腰機時，速度和幅度不能太大，應保持在一個不會加劇疼痛程度的範圍內。如下肢有麻痺、無力等症狀，使用前應先諮詢物理治療師。",
			...
			},
			{
				...
				horizontalPic: require("./../assets/images/horizontal/10.jpg"),
				details:
					"首先，坐穩喺座位上面，向前緊握扶手。兩隻腳踩喺踏板上面。眼望前方，頭向上頂，延伸脊柱。唔好縮膊，膊頭遠離耳仔，膊頭轉向後，挺起胸膛。\n\n然後我哋可以試下屈曲手臂，推拉扶手。做嘅時候保持節奏平穩，輕拉輕放，唔好時快時慢。動作嘅幅度亦唔好過大，以免受傷。\n\n如有腰椎痛，就要諮詢物理治療師建議，先可以決定點樣使用，或者係咪需要停止使用。",

				youtubeKey: "JC0vtfK5i5s",
				kinesiologyTip: "使用者可以利用兩臂推拉扶手作伸展運動及鍛煉全身肌肉。如果持續鍛煉，亦可以增強心肺功能。",
				ptTip:
					"持續的上肢活動除了能鍛煉上肢關節的靈活性，亦能增強心肺功能。適量的有氧運動能夠幫助新冠肺炎康復者等心肺功能較弱的人提升心肺功能。有氧運動亦能控制體重和降低三高（高血壓、高血脂、高血糖），減低患上心血管疾病的風險。做運動時，應保持在自己覺得輕鬆至有點辛苦的難度，運動時應該能夠與人持續對話。",

				otTip: "持續使用這個健身設施可以訓練使用者全身肌肉及心肺功能，對於不同的生活活動，例如穿衣服、梳洗、進食、煮飯等，都會有幫助。",
				careTip:
			...
			},
			{
				...
				horizontalPic: require("./../assets/images/horizontal/11.jpg"),
				details:
					"首先我哋可以緊握扶手，將腳放喺斜踏板嘅最低處，腳後跟需要同斜踏板接觸。保持呢個姿勢，身體軀幹唔可以向後傾。\n\n如果係初級嘅使用者，我哋需要捉住扶手，使用比較低嘅斜踏板。眼望前方，頭向上頂，延伸脊柱。唔好縮膊，膊頭遠離耳仔，膊頭轉向後，挺起胸膛，保持良好嘅姿勢，膝關節伸直，腳後跟記得踏住斜踏板。保持呢個姿勢30秒。呢個時候我哋嘅小腿後方應該有拉扯嘅感覺，但唔應該覺得痛嘅。喺伸展嘅時候，保持正常呼吸。\n\n之後可以休息15秒，然後重複伸展動作2次。\n\n如果係進階嘅使用者，喺運動嘅時候要捉住扶手，同埋要用比較斜嘅斜踏板。",

				youtubeKey: "bKl8JHH4ZHg",
				kinesiologyTip: "這個健身設施能讓使用者的前腳掌高於後腳跟。\n\n維持這個姿勢能令使用者的小腿後方肌肉伸展，增加小腿柔韌度以及足踝靈活性，亦可以增加小腿的活動能力。",
				ptTip: "企斜板可以幫助「足底筋膜炎」和「膝關節炎」的患者增加小腿肌肉的柔軟度，減輕腳底和膝關節的痛楚。企斜板時，腳尖要指著正前方，不要「外八字腳」站立。",

				otTip: "使用這個健身設施能夠提高使用者足踝的靈活性及小腿肌肉的柔軟度。從而提高下肢的活動能力， 並使其在進行穿褲子、襪子，以及出門走路等日常生活活動時變得更加容易。",
				careTip: "觀察及提醒使用者運動時應抬頭挺胸，保持良好姿勢，膝關節亦要伸直。\n\n觀察及提醒使用者保持正常呼吸。\n\n提醒使用者運動時有拉伸感覺即可，不應感到有強烈痛楚。",
			},
			{
				id: 11,
				name: "平衡鍛煉 (半前蹲)",
				...
				horizontalPic: require("./../assets/images/horizontal/12.jpg"),
				details:
					"首先，我哋企喺扶手後面一個手臂位嘅距離。然後一隻腳踏前，膝關節微微屈曲，要注意，踏前嘅膝關節唔可以屈至超過腳趾嘅位置，後腳保持伸直。眼望前方，頭向上頂，延伸脊柱。唔好縮膊，膊頭遠離耳仔，膊頭轉向後，挺起胸膛。唔好過份前傾或後傾。將身體重心保持喺軀幹同後腳上面。\n\n我地可以保持呢個姿勢10秒。然後前腳向後踏，企翻去原本企嘅位置。\n\n我地宜家可以試下用另一隻腳重複以上嘅動作。一隻腳踏前，膝關節微微屈曲，要注意，踏前嘅膝關節唔可以屈至超過腳趾嘅位置，後腳保持伸直。眼望前方，身體保持向上挺直，唔好過份前傾或後傾。將身體重心保持喺軀幹同後腳上面。\n\n我地可以保持呢個姿勢10秒。然後前腳向後踏，企翻去原本企嘅位置。\n\n如果係初級使用者，可以一隻腳踏前，兩隻手握住扶手去保持平衡。\n\n如果係進階使用者，可以按照初級使用者嘅方法運動，但係唔洗握住扶手，但雙手叉腰。",

				youtubeKey: "JCf112TtyHk",
				kinesiologyTip:
					"這個健身設施能夠協助使用者維持半前蹲的姿勢進行訓練。\n\n透過進行半前蹲的動作，使用者可以訓練及增強其腿部肌肉的力量。並在增加腿部柔韌度的同時，提高使用者平衡力。",
				ptTip:
					"半前蹲的動作可以幫助「足底筋膜炎」和「膝關節炎」的患者增加後腳小腿肌肉的柔軟度，減輕腳底和膝關節的痛楚，亦能強化前腳的股四頭肌，幫助平衡力不足的長者預防跌倒。\n\n做半前蹲時，前腿微曲，後腿伸直，注意前後腳的腳尖都要指著正前方，不要向外指。前腿的膝頭也要指向正前方，避免內旋。",

				otTip: "透過使用者這個健身設施，使用者能增強腿部功能、柔韌度以及身體平衡。從而令使用者在日常生活移動的時候，如上落樓梯及巴士更加容易。",
				careTip:
			...
			},
			{
				...
				horizontalPic: require("./../assets/images/horizontal/13.jpg"),
				details:
					"首先雙腳張開至膊頭闊度，手握扶手，將重心移去其中一隻腳，然後將另一隻腳離開地面，單腳站立，如果能保持平衡，慢慢將手離開扶手，雙手叉腰，單腳站立10秒。\n\n如果係初級嘅使用者，雙手握住扶手。\n\n如果係進階嘅使用者，可以將雙手叉腰。",

				youtubeKey: "b9oG6eRfgJI",
				kinesiologyTip: "這個健身設施能協助使用者維持單腳企的動作。\n\n進行單腳企訓練能增強使用者的平衡力感知，以及下肢肌肉的力量。",
				ptTip:
					"單腳企的訓練能強化下肢肌肉和增強平衡力，幫助長者預防跌倒。鍛鍊平衡時一定要注意安全，量力而為。如平衡力不足，練習時不用完全放開雙手，可以先選擇單手扶著或「虛扶」，到平衡力更好時再慢慢放開雙手，增加難度。",

				otTip: "透過使用這個健身設施，使用者能增強平衡力感知，以及下肢肌肉的力量。從而令使用者在日常生活移動的時候，如上落樓梯及巴士更加容易。",
				careTip: "觀察及提醒使用者保持背部平直，挺胸前望，並保持呼吸暢順。\n\n留意使用者身體有否向前傾或後仰，以免發生危險。並觀察及提醒使用者注意安全，如有需要可重新握住扶手。",
			},
			{
				id: 13,
				name: "強健背部",
				...
				horizontalPic: require("./../assets/images/horizontal/14.jpg"),
				details:
					"首先，我哋可以試下用右手握住扶手，左手向天空方向伸展，然後將右腳拉向後，腳尖向地。眼望前方，頭向上頂，延伸脊柱。唔好縮膊，膊頭遠離耳仔，膊頭轉向後，挺起胸膛，運動嗰陣要確保後腳離地。唔好將後腳提得太高，以免對背脊做成壓力。記得要保持呼吸。\n\n保持呢個姿勢10秒，然後休息10秒。\n\n我哋宜家可以試下用左手握住扶手，右臂向天空方向伸展。眼望前方，頭向上頂，延伸脊柱。唔好縮膊，膊頭遠離耳仔，膊頭轉向後，挺起胸膛，運動嗰陣要確保後腳離地。唔好將後腳提得太高，以免對背脊做成壓力。記得保持呼吸。\n\n保持呢個姿勢10秒，然後休息10秒。\n\n如果係初級使用者，可以重複以上動作3次。\n\n如果係進階使用者，可以重複以上動作6次。",

				youtubeKey: "NDCS4T-bbCA",
				kinesiologyTip: "使用這個健身設施時需要使用者維持手腳交替的動作。\n\n這個動作能夠鍛煉使用者的背部肌肉，亦能強化其脊柱附近的肌肉。",
				ptTip:
					"手腳交替的動作可以幫助腰背痛和坐骨神經痛的患者增加脊椎的穩定性，減輕背部和下肢的痛楚。做這個動作時，舉手提腿的幅度避免過大，速度要放慢，盡量保持脊椎穩定，不要「拗腰」。練習時，腰背和下肢的痛楚不應該加強，如痛楚有增加，甚至出現下肢麻痺、無力等症狀，應停止練習並諮詢物理治療師。",
			...
			},
			{
				...
				horizontalPic: require("./../assets/images/horizontal/15.jpg"),
				details:
					"首先手握扶手，雙腳站立嘅指標係手踭微曲，然後將兩腳分開，雙腳距離同膊頭一樣咁闊。做掌上壓嘅時候，我哋首先可以將兩臂屈曲，然後上身向前壓。\n\n宜家維持姿勢3秒，之後身體可以推翻去原位，直至手臂伸直。做嘅過程記住唔好縮膊，沉低膊頭，保持正常呼吸，同埋要保持腰背挺直，注意全身保持直線。\n\n如果係初級嘅使用者，我哋嘅站立位置可以靠前指示牌一啲。\n\n至於進階嘅使用者嘅站立位置，雙腳靠後遠離指示牌多啲。",

				youtubeKey: "TgXPjEX1nnc",
				kinesiologyTip: "這個健身設施可以協助使用者透過上肢肌肉支撐身體重量，以完成站式掌上壓的動作。\n\n透過進行站式掌上壓訓練，可以增強使用者上肢肌肉的力量。",
				ptTip: "/",
				otTip: "持續使用這個健身設施能夠增強使用者上肢肌肉的力量。從而使其在進行日常生活活動時，例如買菜、拿重東西等，都可以更加輕鬆。",
				careTip: "觀察及提醒使用者不要縮膊，儘量沉低肩膀。\n\n觀察及提醒使用者運動時全身保持直線。\n\n觀察及提醒使用者保持正常呼吸。",
			},
			{
				id: 15,
				name: "踏級練習（初階）",
				...
				horizontalPic: require("./../assets/images/horizontal/16.jpg"),
				details:
					"首先，企喺踏級前面，雙手握住扶手，眼望前方，頭向上頂，延伸脊柱。唔好縮膊，膊頭遠離耳仔，膊頭轉向後，挺起胸膛。將右腳踏上級面。然後雙腳企喺級面。右腳先踏落嚟，放翻喺地面。重複動作，今次由左腳開始。\n\n然後將左腳踏上級面。然後雙腳企喺級面。左腳先踏落嚟，放翻喺地面。\n\n後踏上級面嘅腳，應該要係最後踏落地面。我哋宜家重複以上動作5次。\n\n如果係進階嘅使用者，重複以上動作10次。\n\n如果髖關節及、膝關節、腳腕關節喺屈曲嘅時候感到痛楚，要先諮詢物理治療師嘅建議，先決定係咪可以繼續使用。",

				youtubeKey: "-3G0jAm6Tho",
				kinesiologyTip: "透過使用這個健身設施進行踏級練習，使用者可以強化其下肢肌肉的力量。",
				ptTip:
					"踏級練習能幫助髖關節和膝關節炎患者強化臀大肌和股四頭肌，亦能幫助平衡力不足的長者預防跌倒。踏級時，膝頭與腳尖應形成一直線，指向正前方，注意膝關節不要內旋，也不要「外八字腳」站立。\n\n持續的踏級練習亦能增強心肺功能。適量的有氧運動能夠幫助新冠肺炎康復者等心肺功能較弱的人提升心肺功能。有氧運動亦能控制體重和降低三高（高血壓、高血脂、高血糖），減低患上心血管疾病的風險。做運動時，應保持在自己覺得輕鬆至有點辛苦的難度，運動時應該能夠與人持續對話。",

				otTip: "持續使用這個健身設施進行踏級訓練能夠強化使用者下肢肌肉的力量。從而使其在日常移動時，如走路、上樓梯等，會變得更加容易。",
				careTip:
			...
			},
			{
				...
				horizontalPic: require("./../assets/images/horizontal/17.jpg"),
				details:
					"首先坐喺座位上面，一隻手手握扶手，然後另一隻手叉腰，將一隻腳放喺櫈上面，保持下背挺直。如果想增加後腿肌肉拉伸嘅感覺，可以試下嘗試背部向上延伸。而家一邊呼氣，腹部一邊慢慢靠近大髀嘅位置，記得保持正常呼吸。\n\n呢個動作應該會令你大腿後方嘅肌肉有拉緊嘅感覺，但唔會覺得有痛既感覺。\n\n如果係進階嘅使用者，我哋宜家可以坐喺座位上面，將右腳放喺櫈上面。保持下背挺直，背部向上延伸。然後一邊呼氣，一邊雙手交疊，放喺大髀上面，再向膝關節方向向前延伸，喺大腿後方肌肉感到拉緊嘅時候停低。記得保持正常呼吸。\n\n你會感到大腿嘅肌肉有拉緊嘅感覺，但唔會覺得痛楚。",

				youtubeKey: "7F3qzQZqz5k",
				kinesiologyTip: "透過將其中一隻腳放在櫈上，使用者可以利用這個健身設施伸展大腿後方的肌肉，並增加腿部的柔韌度。",
				ptTip:
					"這個動作可以幫助腰背痛和膝關節炎患者增加大腿後方肌肉的柔軟度，減輕腰背和膝關節的痛楚。做這個動作時，櫈上面隻腳的膝頭要伸直，腳板底勾起，背部保持挺直，然後慢慢摺胯，將腹部壓下。大腿後面的肌肉會有伸展的感覺，但不應出現疼痛。",

				otTip: "透過使用這個健身設施進行腿部拉伸，使用者可以提高其腿部柔韌度，並使其在進行日常生活活動時，如穿褲子、襪子、出入浴缸更加輕鬆。",
				careTip:
					"留意使用者是否能平衡身體，防止跌倒。\n\n觀察及提醒使用者每次只可以放一隻腳在椅子上。伸展時要動作要緩慢，逐步伸展，動作太大或太快會有受傷的風險。\n\n觀察及提醒使用者運動時運動時保持下背挺直，運動時有拉伸感覺即可，不應感到有強烈痛楚。\n\n觀察及提醒使用者保持正常呼吸。",
			},
			{
				id: 17,
				name: "健體單車/腳部跑步器",
				...
				horizontalPic: require("./../assets/images/horizontal/18.jpg"),
				details:
					"先坐喺座位上面，然後雙手緊握扶手，雙腳放喺腳踏上面。注意眼望前方，頭向上頂，延伸脊柱。唔好縮膊，膊頭遠離耳仔，膊頭轉向後，挺起胸膛，之後就可以做踩單車嘅運動。上落單車嘅時候要小心。如果髖關節及、膝關節、腳腕關節喺屈曲嘅時候感到痛楚，要先諮詢物理治療師嘅建議，先決定係咪可以繼續使用。\n\n初級嘅使用者可以重複以上動作20次。\n\n進階嘅使用者可以重複以上動作20次。",

				youtubeKey: "15cShHBques",
				kinesiologyTip:
					"這個健身設施能讓使用者模擬進行踏單車運動。\n\n一般而言，踏單車是一種氧運動，可以增強心肺功能。另外，在踩單車嘅時候，提高腿部的動作可以增強腿部肌肉群的力量，髖關節以及膝關節的活動能力亦可以有所提升。",
				ptTip:
					"踩單車有助於髖關節和膝關節炎患者鍛煉下肢的力量和靈活性。如關節炎較嚴重，應該選擇座椅較高的單車機，減低膝關節活動幅度，減輕對膝關節的磨損。\n\n持續地踩單車除了能鍛煉下肢的力量和靈活性，亦能增強心肺功能。適量的有氧運動能夠幫助新冠肺炎康復者等心肺功能較弱的人提升心肺功能。有氧運動亦能控制體重和降低三高（高血壓、高血脂、高血糖），減低患上心血管疾病的風險。做運動時，應保持在自己覺得輕鬆至有點辛苦的難度，運動時應該能夠與人持續對話。",

				otTip: "透過使用這個健身設施進行踏單車訓練，使用者可以增強其腿部功能以及關節活動能力，對其出入浴缸、走樓梯、上落巴士等日常移動都有所幫助。",
				careTip:
			...
			},
			{
				...
				horizontalPic: require("./../assets/images/horizontal/19.jpg"),
				details:
					"雙手緊握扶手，兩腳踩喺踏板上面。眼望前方，頭向上頂，延伸脊柱。唔好縮膊，膊頭遠離耳仔，膊頭轉向後，挺起胸膛，保持良好姿勢。\n\n然後兩隻腳交替擺動，模擬漫步嘅動作。注意唔好雙腳同時擺動，以免身體失去重心。模擬漫步動作嘅速度要平均以及適中，唔適宜太快或太慢。擺動幅度亦唔好過大。",

				youtubeKey: "4_IDUrYSDdY",
				kinesiologyTip: "這個健身設施能夠模擬漫步的動作。\n\n透過雙腳交替擺動，使用者可以鍛煉下肢，並加強心肺功能。",
				ptTip:
					"漫步機能夠幫助髖關節炎患者鍛煉下肢的力量和靈活性。漫步時，力度和幅度不用太大，應保持在一個不會加劇疼痛程度的範圍內。\n\n持續地漫步除了能鍛煉下肢的力量和靈活性，亦能增強心肺功能。適量的有氧運動能夠幫助新冠肺炎康復者等心肺功能較弱的人提升心肺功能。有氧運動亦能控制體重和降低三高（高血壓、高血脂、高血糖），減低患上心血管疾病的風險。做運動時，應保持在自己覺得輕鬆至有點辛苦的難度，運動時應該能夠與人持續對話。",
			...
			},
			{
				...
				horizontalPic: require("./../assets/images/horizontal/20.jpg"),
				details:
					"首先雙手握住轉輪。眼望前方，頭向上頂，延伸脊柱。唔好縮膊，膊頭遠離耳仔，膊頭轉向後，挺起胸膛，保持良好姿勢。然後，雙手可以慢慢平穩順時針轉動轉輪。注意身體軀幹保持平穩性。\n\n我哋宜家可以雙手握住轉輪嘅手柄，雙手可以慢慢平穩逆時針轉動轉輪。雙手應該要緊握手柄，注意身體平衡。\n\n轉動嘅時候速度要平穩，唔好時快時慢，之後可以休息一下。\n\n如果係肩膊關節炎患者，就要先諮詢物理治療師意見先至可以決定點樣使用，或者決定需唔需要停止使用。",

				youtubeKey: "oWBISdEwFyo",
				kinesiologyTip: "透過雙手轉動設施上轉輪，使用者可以增強其上肢關節的靈活性，以及肌肉的柔韌性。",
				ptTip: "柔和的關節活動有助於「五十肩」和肩關節炎患者保持肩關節的活動幅度並減輕肩膊的疼痛。使用轉輪時，轉動的力度和幅度不能太大，應保持在一個不會加劇疼痛程度的範圍內。",

				otTip: "使用這個健身設施能夠增強使用者肩關節的柔韌性。從而使其進行上肢日常活動時（如穿衣服、梳洗、擦窗戶、聽電話）能夠更加輕鬆。",
				careTip:
			...
			},
			{
				...
				horizontalPic: require("./../assets/images/horizontal/21.jpg"),
				details:
					"雙腳站立時距離同膊頭一樣咁闊，雙手分別握住兩邊手柄。然後一隻手將繩向下拉，另一隻手伸直抓緊手柄。兩隻手輪流交替做出伸展嘅動作。\n\n呢個動作著重嘅係上肢伸展嘅幅度，而唔係追求速度，所以用適中嘅速度就可以啦。做拉繩動作嘅時候，記得保持軀幹穩定性。\n\n運動嗰陣，要保持條繩垂直嘅，避免打斜拉繩，亦要避免單手拉繩，以免拉傷手臂。我地宜家可以試下開始做呢個動作。",

				youtubeKey: "TlTf9M84C94",
				kinesiologyTip: "透過左右手交替拉動設施上的拉桿或拉繩，可以增強使用者上肢關節的靈活度。",
				ptTip:
					"柔和的關節活動有助於「五十肩」和肩關節炎患者保持肩關節的活動幅度和柔韌度。拉繩時，雙手的位置可以在身體的前面或旁邊去拉，但要避免在身體後面的位置去拉。拉繩的力度和幅度避免太大，應保持在一個不會加劇疼痛程度的範圍內。如有一邊的手相對無力或疼痛，可以利用另一隻手的力量去拉動較弱的那邊。如果要達到伸展的效果，可以在拉到自己能力範圍內的最高處時，停留數秒時間後才慢慢放下來。",

				otTip: "使用這個健身設人施進行拉繩動作的訓練能夠增強使用者上肢關節的靈活度。從而使其進行日常活動時（如擦桌子、拿東西、洗澡、穿衣服等）能夠更加輕鬆。",
				careTip: "觀察及提醒使用者拉繩時切勿過快，亦不要兩手同時拉繩。\n\n留意使用者運動時是否保持繩索垂直，避免打斜拉繩索。\n\n觀察及提醒使用者不可單手拉繩，以免拉傷手臂。",
			},
			{
				id: 21,
				name: "踏步機",
				...
				pic: "",
				horizontalPic: require("./../assets/images/horizontal/22.jpg"),
				details: "雙手緊握扶手，兩腳踩喺踏板上面。然後雙腳配合雙手上下擺動。\n\n運動嘅時候唔好完全伸直兩邊膝關節，亦要留意唔好過份屈曲膝關節。踩動嘅速度要平均，唔好時快時慢。",

				youtubeKey: "ktO92CXy1WA",
				kinesiologyTip: "這個健身設施可以協助使用者進行踏步的動作。從而鍛煉其下肢以及身體的平衡感知。持續鍛煉亦可以增強呼吸系統功能。",
				ptTip:
					"踏步機能幫助髖關節和膝關節炎患者強化臀大肌和股四頭肌，亦能幫助平衡力不足的長者預防跌倒。踏步時，膝頭與腳尖應形成一直線，指向正前方，注意膝關節不要內旋，也不要「外八字腳」站立。\n\n持續的踏步練習亦能增強心肺功能。適量的有氧運動能夠幫助新冠肺炎康復者等心肺功能較弱的人提升心肺功能。有氧運動亦能控制體重和降低三高（高血壓、高血脂、高血糖），減低患上心血管疾病的風險。做運動時，應保持在自己覺得輕鬆至有點困難的辛苦程度，運動時應該能夠與人持續對話的強度。",
			...
			},
			{
				...
				horizontalPic: require("./../assets/images/horizontal/23.jpg"),
				details:
					"首先手握扶手，將腰部挨喺橫向嘅按摩器上面，然後上下慢慢移動。利用按摩器上面嘅凸點，按摩覺得需要放鬆嘅部位。\n\n移動嘅時候速度可以慢少少，會更加容易揾到需要按摩嘅位置。按摩嘅時候亦要注意力度適中，唔需要太大力。\n\n之後我哋雙手呈90度平衡，將背部挨喺直向嘅按摩器上面，然後左右慢慢移動。利用按摩器上面嘅凸點，按摩覺得需要放鬆嘅部位。\n\n移動嘅時候速度可以慢少少，會更加容易揾到需要按摩嘅位置。按摩嘅時候亦要注意力度適中，唔需要太大力。\n\n如果按摩嗰陣，腰部或背部感到痛楚，要先諮詢物理治療師嘅建議，先決定係咪可以繼續使用。",

				youtubeKey: "LWwOrOy300k",
				kinesiologyTip: "這個健身設施能協助使用者進行腰背的按摩。\n\n使用者能利用這個健身設施上的滾筒凸點按摩下腰部以放鬆相關肌肉，並增強腰背部的血液循環。",
				ptTip:
					"腰背按摩可以幫助腰背痛和坐骨神經痛的患者放鬆腰背的肌肉，減輕背部和下肢的痛楚。按摩時，可以利用滾筒來回按摩，或在比較繃緊酸痛的位置定點按壓。按摩的力度要適中，不要加劇腰背和下肢的痛楚。如痛楚有增加，甚至出現下肢麻痺、無力等症狀，應停止並諮詢物理治療師。",

				otTip: "使用者可以透過這個健身設施進行腰背按摩，紓緩其腰背痛楚的問題。從而令使用者在進行涉及下腰肌肉的活動時（如煮飯、行路、清潔）會更輕鬆。",
				careTip: "如果使用者在按摩時，腰部或背部感到痛楚，應先諮詢物理治療師的建議，才可決定如何使用或是否繼續使用。\n\n觀察及提醒使用者按摩時需注意力度適中。",
			},
			{
				id: 23,
				...
				horizontalPic: require("./../assets/images/horizontal/24.jpg"),
				details:
					"首先，坐喺座位上面，兩隻手可以緊握住個手柄，然後慢慢向前轉動個扶手。\n\n轉動扶手嘅同時記得保持良好的姿勢。眼望前方，頭向上頂，延伸脊柱。唔好縮膊，膊頭遠離耳仔，膊頭轉向後，挺起胸膛。\n\n我地宜家試下雙手向前轉動個扶手。記得力度要適中，轉速亦都要平均，唔好時快時慢。",

				youtubeKey: "qxQ6vmsCfLU",
				kinesiologyTip: "上肢運動：利用轉動扶手的動作，呢部器材能夠鍛煉上肢關節的靈活性。",
				ptTip: "轉動扶手的練習有助於保持上肢關節的靈活性。轉動扶手時，速度和力度不用太大，應保持在一個不會加劇疼痛程度的範圍內。",

				otTip: "這個健身設施能夠鍛煉使用者上肢關節的靈活性。從而令使用者能更輕鬆地進行日常生活的活動（例如擦桌子、拿東西、洗澡、穿衣服等）。",
				careTip:
			...
			},
			{
				...
				horizontalPic: require("./../assets/images/horizontal/25.jpg"),
				details:
					"坐喺座位上面，雙腳放喺腳踏上面。注意眼望前方，頭向上頂，延伸脊柱。唔好縮膊，膊頭遠離耳仔，膊頭轉向後，挺起胸膛，之後就可以交替踩腳踏，令腳踏慢慢向前轉動。要留意身體平衡，小心失平衡。如果髖關節、膝關節、腳腕關節喺屈曲嘅時候感到痛楚，要先諮詢物理治療師嘅建議，先決定係咪可以繼續使用。",

				youtubeKey: "Hb98QPvOXKc",
				kinesiologyTip: "下肢運動：交替踩腳踏的時候，提高腿部的動作可以增強腿部肌肉群的力量，同時亦能提升膝關節及足踝關節的活動能力。",
				ptTip:
					"踩腳踏有助於髖關節和膝關節炎患者鍛煉下肢的力量和靈活性。訓練時，踩腳踏的速度和力度不用太大，應保持在一個不會加劇疼痛程度的範圍內。如關節炎較嚴重，應該選擇座椅較高或較後的腳踏，減輕對膝關節的磨損。",

				otTip: "透過交替踩腳踏的訓練，使用者能夠提升其腿部肌肉群的力量、膝關節及足踝關節的活動能力。對其走路、走樓梯、上落巴士等日常移動都有所幫助。",
				careTip:
					"觀察及提醒使用者運動時頭向上頂，延伸脊柱。眼望前方，膊頭轉向後，挺起胸膛。\n\n如果使用者在運動時，髖關節及、膝關節及腳腕關節在屈曲時候感到痛楚，應先諮詢物理治療師的建議，才可決定如何使用或是否繼續使用。",
			},
			{
				...
				horizontalPic: require("./../assets/images/horizontal/26.jpg"),
				details:
					"首先握著扶手，將其中一隻腳放喺橫桿上面，保持下背挺直。如果想增加後腿肌肉拉伸嘅感覺，可以試下嘗試背部向上延伸。而家一邊呼氣，腹部一邊慢慢靠近大髀嘅位置，記得保持正常呼吸。\n\n呢個動作應該會令你大腿後方嘅肌肉有拉緊嘅感覺，但唔會覺得痛楚。\n\n我哋而家可以握著扶手，然後將左腳放喺橫桿上面。保持下背挺直。背部向上延伸，而家一邊呼氣，腹部一邊慢慢靠近大髀嘅位置，動作要緩慢，唔好太快。如果肌肉太緊繃嘅話，可以維持喺目前嘅姿勢，唔需要將腹部靠近大髀。記得保持正常呼吸。\n\n你會感到大腿嘅肌肉有拉緊嘅感覺，但唔會覺得痛楚。\n\n保持呢個姿勢，然後放低隻腳，休息一下。\n\n我哋而家可以握著扶手，然後將右腳放喺橫桿上面。保持下背挺直。背部向上延伸，而家一邊呼氣，腹部一邊慢慢靠近大髀嘅位置，動作要緩慢，唔好太快。如果肌肉太緊繃嘅話，可以維持喺目前嘅姿勢，唔需要將腹部靠近大髀。記得保持正常呼吸。\n\n保持呢個姿勢，然後放低隻腳，休息一下。",

				youtubeKey: "NJWSiegBkVo",
				kinesiologyTip: "透過將其中一隻腳放在橫桿上面，使用者可以伸展下腰及大腿後方的肌肉，增加相關部位的柔韌度。",
				ptTip:
					"壓腿器可以幫助腰背痛和膝關節炎患者增加大腿後方肌肉的柔軟度，減輕腰背和膝關節的痛楚。壓腿的時候，橫桿上面隻腳的膝頭要伸直，背部保持挺直，然後慢慢摺胯，將腹部壓下。大腿後面的肌肉會有伸展的感覺，但不應出現疼痛。",

				otTip: "使用這個健身設施能夠伸展下腰及大腿後方肌肉及提升其柔韌度，使穿褲子、襪子、出入浴缸等日常生活活動更加輕鬆。",
				careTip:
			...
			},
			{
				...
				ptTip:
					"雙腳擺動有助膝關節炎患者鍛鍊下肢的力量和靈活性。訓練時，擺動的幅度和力度不用太大，應保持在一個不會加劇疼痛程度的範圍內。如關節炎較嚴重，應該選擇座椅較高的座位或坐後一點（距離腳踏遠一點）以減輕對膝關節的磨損。",
				otTip: "使用這個健身設施能增加使用者的膝關節以及腳踝關節柔靭性。對其走路、走樓梯、上落巴士等日常移動都有所幫助。",
				careTip:
					"觀察及提醒使用者切勿雙腳同時擺動，速度需適中，擺動幅度不能過大，以免發生危險。\n\n留意使用者的軀幹穩定性，如果觀察到使用者的身體軀幹在搖擺，即表示速度有可能太快，提醒使用者調整速度。",
			},
			{
				...
				ptTip:
					"轉動扶手的練習有助於保持上肢關節的靈活性。轉動扶手時，速度和力度不用太大，應保持在一個不會加劇疼痛程度的範圍內。\n\n持續的上肢活動除了能鍛鍊上肢關節的靈活性，亦能增強心肺功能。適量的有氧運動能夠幫助新冠肺炎康復者等心肺功能較弱的人提升心肺功能。有氧運動亦能控制體重和降低三高（高血壓、高血脂、高血糖），減低患上心血管疾病的風險。做運動時，應保持在自己覺得輕鬆至有點辛苦的難度，運動時應該能夠與人持續對話。",
				otTip: "使用這個健身設施能提高使用者上肢關節的靈活性，使其在進行日常生活的動作時（例如擦桌子、梳洗、洗澡、穿衣服等）也能更輕鬆地完成。",
...
export const gifFiles1 = {
	0: require("@/assets/images/gif/1a.gif"),
	1: require("@/assets/images/gif/2a.gif"),
	2: require("@/assets/images/gif/3a.gif"),
	3: require("@/assets/images/gif/4a.gif"),
	4: require("@/assets/images/gif/5a.gif"),
	5: require("./../assets/images/gif/6a.gif"),
	6: require("./../assets/images/gif/7a.gif"),
	7: require("./../assets/images/gif/8a.gif"),
	8: require("./../assets/images/gif/9a.gif"),
	9: require("./../assets/images/gif/10a.gif"),
	10: require("./../assets/images/gif/11a.gif"),
	11: require("./../assets/images/gif/12a.gif"),
	12: require("./../assets/images/gif/13a.gif"),
	13: require("./../assets/images/gif/14a.gif"),
	14: require("./../assets/images/gif/15a.gif"),
	15: require("./../assets/images/gif/16a.gif"),
	16: require("./../assets/images/gif/17a.gif"),
	17: require("./../assets/images/gif/18a.gif"),
	18: require("./../assets/images/gif/19a.gif"),
	19: require("./../assets/images/gif/20a.gif"),
	20: require("./../assets/images/gif/21a.gif"),
	21: require("./../assets/images/gif/22a.gif"),
	22: require("./../assets/images/gif/23a.gif"),
	23: require("./../assets/images/gif/24a.gif"),
	24: require("./../assets/images/gif/25a.gif"),
	25: require("./../assets/images/gif/26a.gif"),
	26: require("./../assets/images/gif/27a.gif"),
	27: require("./../assets/images/gif/28a.gif"),
};

// 1 to 28
export const gifFiles2 = {
	0: require("@/assets/images/gif/1b.gif"),
	1: require("@/assets/images/gif/2b.gif"),
	2: require("@/assets/images/gif/3b.gif"),
	3: require("@/assets/images/gif/4b.gif"),
	4: require("@/assets/images/gif/5b.gif"),
	5: require("@/assets/images/gif/6b.gif"),
	6: require("@/assets/images/gif/7b.gif"),
	7: require("@/assets/images/gif/8b.gif"),
	8: require("@/assets/images/gif/9b.gif"),
	9: require("@/assets/images/gif/10b.gif"),
	10: require("@/assets/images/gif/11b.gif"),
	11: require("@/assets/images/gif/12b.gif"),
	12: require("@/assets/images/gif/13b.gif"),
	13: require("@/assets/images/gif/14b.gif"),
	14: require("@/assets/images/gif/15b.gif"),
	15: require("@/assets/images/gif/16b.gif"),
	16: require("@/assets/images/gif/17b.gif"),
	17: require("@/assets/images/gif/18b.gif"),
	18: require("@/assets/images/gif/19b.gif"),
	19: require("@/assets/images/gif/20b.gif"),
	20: require("@/assets/images/gif/21b.gif"),
	21: require("@/assets/images/gif/22b.gif"),
	22: require("@/assets/images/gif/23b.gif"),
	23: require("@/assets/images/gif/24b.gif"),
	24: require("@/assets/images/gif/25b.gif"),
	25: require("@/assets/images/gif/26b.png"),
	26: require("@/assets/images/gif/27b.gif"),
	27: require("@/assets/images/gif/28b.gif"),
};
